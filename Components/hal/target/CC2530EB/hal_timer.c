...
#define HAL_TIMER1_16_PRESCALE_8     HAL_TIMER1_16_TC_DIV8
#define HAL_TIMER1_16_PRESCALE_8_VAL  8
...
void HalTimerInit (void)
{
  ...
  halTimerRecord[HW_TIMER_1].prescale    = 0x04;
  halTimerRecord[HW_TIMER_1].clock       = HAL_TIMER_32MHZ;
  halTimerRecord[HW_TIMER_1].prescaleVal = 8;
